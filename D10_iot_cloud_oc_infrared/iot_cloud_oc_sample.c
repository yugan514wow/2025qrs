...
#define CONFIG_WIFI_SSID "wow" // 修改为自己的WiFi 热点账号
...
#define CONFIG_APP_DEVICEID "6832a4579314d118511f4674_20041224wow" // 替换为注册设备后生成的deviceid

#define CONFIG_APP_DEVICEPWD "walxg041224" // 替换为注册设备后生成的密钥
...
static void deal_report_msg(void)
{
    ...
    status.value = g_infraredStatus ? "有人" : "安全";
